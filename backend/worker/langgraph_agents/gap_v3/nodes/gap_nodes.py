...
def _build_merged_gap_prompt(cv_text: str, jd_text: str, language: str = "Vietnamese") -> str:
    ...
    return (
        ...
        '    "weaknesses": ["..."],\n'
        '    "skill_gaps": [\n'
        '       { "skill": "...", "category": "Technical Skills|Soft Skills|Tools & Frameworks|Domain Knowledge|Certifications", "is_group": boolean, "alternative_skills": ["..."], "required_level": "Beginner|Intermediate|Advanced", "severity": "Low|Medium|High|Critical", "is_critical": boolean, "match_impact": number (0-100), "market_demand": number (0-10), "estimated_months": number, "reasoning": "Vietnamese", "learning_path": "Vietnamese" }\n'
        '    ],\n'
