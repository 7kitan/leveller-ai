...
-- Update existing jobs to have default classification
-- (They will be re-classified when skills are re-extracted)
UPDATE jobs 
SET is_tech_job = TRUE,
    job_primary_domain = 'Unknown',
    job_classification_confidence = NULL
WHERE is_tech_job IS NULL;
