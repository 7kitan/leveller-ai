...
def scrape_coursera_course(url):
    print(f"Bắt đầu trích xuất dữ liệu: {url}...")
...
if __name__ == "__main__":
    url_input = input("Nhập URL Coursera (Enter dùng mặc định): ").strip()
    url = url_input if url_input else "https://www.coursera.org/learn/python-for-applied-data-science-ai"
